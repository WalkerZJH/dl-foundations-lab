...
class CaptioningRNN:
    ...
    def loss(self, features, captions):
        ...
        loss = 0.0
        ############################################################################
        # Implemented: forward pass for the CaptioningRNN.                         #
        ...
        ############################################################################
        features = features.to(dtype=W_proj.dtype)
        captions_in = captions_in.to(dtype=torch.long)
        captions_out = captions_out.to(dtype=torch.long)
    ...
    def sample(self, features, max_length=30):
        ...
        ###########################################################################
        # Implemented: test-time sampling for the model. The sampling path         #
        ...
        for t in range(max_length):
            ...
            if self.cell_type == "rnn":
                ...
                prev_h, prev_c = lstm_step_forward(word_vector, prev_h, prev_c, Wx, Wh, b)
