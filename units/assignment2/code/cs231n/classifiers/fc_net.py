...
class FullyConnectedNet(object):
    ...
    def __init__(
        ...
        ############################################################################
        # Implemented: initialize the parameters of the network, storing values in #
    ...
    def loss(self, X, y=None):
        ...
        scores = None
        ############################################################################
        # Implemented: forward pass for the fully connected net, computing         #
        ...
        loss, grads = 0.0, {}
        ############################################################################
        # Implemented: backward pass for the fully connected net. Store the        #
