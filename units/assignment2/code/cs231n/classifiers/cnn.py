...
class ThreeLayerConvNet(object):
    ...
    def __init__(
        ...
        ############################################################################
        # Implemented: initialize weights and biases for the three-layer           #
    ...
    def loss(self, X, y=None):
        ...
        scores = None
        ############################################################################
        # Implemented: forward pass for the three-layer convolutional net,         #
        ...
        loss, grads = 0, {}
        ############################################################################
        # Implemented: backward pass for the three-layer convolutional net,        #
