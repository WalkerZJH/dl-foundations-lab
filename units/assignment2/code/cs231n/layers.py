...
def batchnorm_forward(x, gamma, beta, bn_param):
    ...
    if mode == "train":
        #######################################################################
        # Implemented: training-time forward pass for batch norm.             #
        ...
        #######################################################################
        # Implemented: test-time forward pass for batch normalization.        #
...
def dropout_forward(x, dropout_param):
    ...
    if mode == "train":
        #######################################################################
        # Implemented: training phase forward pass for inverted dropout.      #
        ...
        #######################################################################
        # Implemented: test phase forward pass for inverted dropout.          #
        #######################################################################
        out = x
        #######################################################################
        #                            END OF YOUR CODE                         #
...
def dropout_backward(dout, cache):
    ...
    if mode == "train":
        #######################################################################
        # Implemented: training phase backward pass for inverted dropout      #
        #######################################################################
        dx = dout * mask
        #######################################################################
        #                          END OF YOUR CODE                           #
